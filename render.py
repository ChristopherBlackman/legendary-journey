...
def main():
	...
	os.system('echo "markdown templates/md/manga/manga.md > templates/html/manga/body.html" ')
	os.system('markdown templates/md/manga/manga.md > templates/html/manga/body.html')
	...
	manga = Exagogi(base_path + 'manga/manga.html', base_output_path + 'manga.html', base_path + 'manga/body.html',block)
	about.render()
	home.render()
	projects.render()
	resume.render()
